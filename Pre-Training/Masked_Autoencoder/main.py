...
def main_pt():
    ...
    if ep_start >= args.ep: # load from a complete checkpoint file
        ...
        for ep in range(ep_start, args.ep):
            ...
            misc.save_checkpoint_for_finetune(f'{args.model}_1kpretrained.pth', args, model_without_ddp.sparse_encoder.sp_cnn.state_dict(), ep, last_loss) # ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Pass epoch-numer and loss
