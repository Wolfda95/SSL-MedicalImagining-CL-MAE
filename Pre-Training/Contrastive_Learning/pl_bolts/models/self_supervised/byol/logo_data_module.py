...
from logo_data_set import LoGoDataset
...
class LoGoDataModule(LightningDataModule):
    ...
    def setup(self, stage: str = None):
        ...
        """
        if stage == "fit":
            self.train_set = LoGoDataset(self.data_dir, self.tau_g, self.tau_l)
        else:
...
if __name__ == "__main__":
    ...
    dm = LoGoDataModule("/mnt/hdd/datasets/Imagenet100/train")
    dm.setup(stage="fit")
